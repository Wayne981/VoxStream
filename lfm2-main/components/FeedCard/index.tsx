        ...
        <div className="flex-grow">
          ...
          <div className="flex justify-between mt-2 text-gray-500 max-w-md">
            ...
            <button className="flex items-center space-x-2 group">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5 text-gray-500 transition-colors duration-200 ease-in-out group-hover:text-blue-500">
                <path d="M18 7l3 3-3 3"/>
                <path d="M21 10H7a4 4 0 0 0-4 4v2"/>
                <path d="M6 17l-3 3 3 3"/>
                <path d="M3 20h14a4 4 0 0 0 4-4v-2"/>
              </svg>
              <span className="text-sm text-gray-500 transition-colors duration-200 ease-in-out group-hover:text-blue-500"></span>
            </button>
            <button 
